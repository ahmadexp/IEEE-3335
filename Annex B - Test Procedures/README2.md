> Editor's note from Rodney C: This readme was misplaced in Conformance, which is not about testing. I moved it here so that it can be merged with the other readme.
